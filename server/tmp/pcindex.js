...
html+=`/img/index.png" alt=""><img src="`
html+= _data.staticHost + _data.pcPath 
html+=`/img/test/test.jpg" alt="">`
html+=getHtml('test/test.html',_data);
html+=`<img src="//www.baidu.com/img/bd_logo1.png" alt="">`
html+=getHtml('test/test2/test2.html',_data);
html+=`<video id="bgvideo" width="100%" height="100%" controls src="http://app.inke.com/inke/v/video.mp4" loop="" >您的浏览器不支持video标签，建议更新浏览器版本</video><ul>`
